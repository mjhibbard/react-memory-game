...
class MemoryGame extends Component {
  constructor(props) {
    ...
    let cards = [
      ...
      {id: 2, cardState: CardState.HIDING, backgroundColor: 'lightskyblue'},
      {id: 3, cardState: CardState.HIDING, backgroundColor: 'lightskyblue'},
      {id: 4, cardState: CardState.HIDING, backgroundColor: 'navy'},
      {id: 5, cardState: CardState.HIDING, backgroundColor: 'navy'},
      ...
      {id: 14, cardState: CardState.HIDING, backgroundColor: 'pink'},
      {id: 15, cardState: CardState.HIDING, backgroundColor: 'pink'}
    ];
    cards = shuffle(cards);
